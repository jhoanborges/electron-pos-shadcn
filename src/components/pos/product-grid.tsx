    ...
    return (
        <div className="flex flex-col h-full">
            ...
            >
                ...
                <TabsContent value={activeCategory} className="flex-1 mt-2 overflow-auto">
                    <div className={`grid ${gridColsClass} gap-4 auto-rows-min`}>
                        {filteredProducts.map((product) => (
                            <Card
                                key={product.id}
                                className="cursor-pointer hover:border-primary transition-colors p-1"
